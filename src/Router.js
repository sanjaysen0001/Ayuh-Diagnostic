...
//   import("./Diagnosticpages/Dashboard.js")
// );
...
const Editprofile = lazy(() => import("./Diagnosticpages/Editprofile.js"));
const Pendingreportlist = lazy(() =>
  import("./Diagnosticpages/Pendingreportlist.js")
);
const Test = lazy(() => import("./Diagnosticpages/Test.js"));
const Testview =lazy(()=>import("./Diagnosticpages/Testview.js"))
const Testadd = lazy(() => import("./Diagnosticpages/Testadd.js"));
const Testaddlist = lazy(() => import("./Diagnosticpages/Testadd.js"));
...
const diagnosticlist = lazy(() =>
  import("./views/apps/user/Diagnosticlist.js")
);
...
const Editdeliver = lazy(() => import("./views/apps/user/Editdeliver.js"));
const EditUser = lazy(() => import("./views/apps/user/EditUser"));
const Edittestlist = lazy(() => import("./views/apps/user/Edittestlist.js"));
...
const Callhistorymanagement = lazy(() =>
  import("./views/apps/Businessmanagement/Callshistorymanagement.js")
);
...
const Activity = lazy(() =>
  import("./views/dashboard/analytics/ActivityTimeline")
);
const DispatchedOrders = lazy(() =>
  import("./views/dashboard/analytics/DispatchedOrders")
);
...
const Listcategoryadd = lazy(() =>
  import("./views/apps/productmanager/product/Listcategoryadd.js")
);
...
const Addsubcategory = lazy(() =>
  import("./views/apps/productmanager/product/Addsubcategory.js")
);
const Editsubcategory = lazy(() =>
  import("./views/apps/productmanager/product/Editsubcategory.js")
);
const Testlistadd = lazy(() => import("./Diagnosticpages/Testadd.js"));
...
const CategoryList = lazy(() =>
  import("../src/Diagnosticpages/Addcategorylist.js")
);
...
const invoice = lazy(() => import("./views/pages/Invoice/Invoice.js"));
const Prescribtion = lazy(() =>
  import("./views/pages/Prescribtion/Prescribtion.js")
);
const Reportdiagno = lazy(() =>
  import("./views/pages/Reports/Reportdiagno.js")
);
      ...
      <Router history={history}>
        <HashRouter>
          <Switch>
            ...
            <AppRoute path="/Sub-category" component={Subcategory} />
            <AppRoute path="/Deliver-report-list" component={Deliverreport} />
            <AppRoute path="/Rejected-report-list" component={Rejectedreport} />
            <AppRoute path="/Editprofile" component={Editprofile} />
            <AppRoute
              path="/Pending-report-list"
              component={Pendingreportlist}
            />
            <AppRoute path="/Test" component={Test} />
            <AppRoute path="/Testview/:id" component={Testview}/>
            <AppRoute path="/Add-list" component={Testlistadd} />
            <AppRoute
              exact={true}
            ...
            <AppRoute
              path="/Pending-report-rist/Edit-report/:id"
              component={EditUser}
            />
            <AppRoute path="/Edit-test-list/:id" component={Edittestlist} />
            <AppRoute
              path="/Deliver-report-rist/View-report/:id"
              component={ViewUser}
            />
            <AppRoute
              path="/Deliver-report-rist/Edit-report/:id"
            ...
            />
            <AppRoute path="/Category/Add" component={CategoryList} />
            <AppRoute
            ...
            />
            <AppRoute path="Add-list" component={AddAstrologer} />
            <AppRoute
            ...
            />
            <AppRoute
              path="/dashboard/analytics/ActivityTimeline"
              component={Activity}
            />
            <AppRoute
              path="/dashboard/analytics/DispatchedOrders"
            ...
            <AppRoute path="/page/Prescribtion" component={Prescribtion} />
            <AppRoute path="/Page/Reportdiagno" component={Reportdiagno} />
            <AppRoute
              exact={true}
